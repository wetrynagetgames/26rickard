...
class Gamepad final : public Bindings::PlatformObject {
    ...
    JS_DECLARE_ALLOCATOR(Gamepad);

public:
    static WebIDL::ExceptionOr<JS::NonnullGCPtr<Gamepad>> create(JS::Realm&, NonnullRefPtr<Core::Gamepad> gamepad);
    ...
    WebIDL::ExceptionOr<Vector<JS::NonnullGCPtr<GamepadButton>>> const buttons();
