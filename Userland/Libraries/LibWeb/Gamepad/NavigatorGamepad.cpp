...
WebIDL::ExceptionOr<Vector<JS::GCPtr<Gamepad>>> NavigatorGamepadMixin::get_gamepads()
{
    ...
    if (!doc.is_fully_active())
        return Vector<JS::GCPtr<Gamepad>> {};
    ...
    Vector<JS::GCPtr<Gamepad>> gamepads;
...
WebIDL::ExceptionOr<JS::GCPtr<Gamepad>> NavigatorGamepadMixin::construct_gamepad(AK::NonnullRefPtr<Core::Gamepad> underlaying_gamepad)
{
