...
public:
    ...
    void store_layout_inside_run_info(LayoutState* layoutState, AvailableSpace const availableSpace);

    virtual JS::GCPtr<Painting::Paintable> create_paintable() const override;

    // Save info for layout invalidation input box fast path
    AvailableSpace m_run_available_space = AvailableSpace(AvailableSize(AvailableSize::Type::Definite, CSSPixels(0)), AvailableSize(AvailableSize::Type::Definite, CSSPixels(0)));
