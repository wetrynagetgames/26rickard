...
bool code_unit_less_than(StringView a, StringView b)
{
    ...
    auto code_units_a = utf8_to_utf16(a).release_value_but_fixme_should_propagate_errors();
    auto code_units_b = utf8_to_utf16(b).release_value_but_fixme_should_propagate_errors();
